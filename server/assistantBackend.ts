import { compactScribeCommands, scribeCommandGuidance } from "../src/utils/scribeCommands.ts";
...
Known Scribe command shortcuts:
${scribeCommandGuidance}`
          },
          {
            role: "user",
...
function buildAssistantLoreContext(database: AssistantBackendRequest["database"], command: string) {
  ...
  return {
    ...
    scribeCommands: compactScribeCommands(),
